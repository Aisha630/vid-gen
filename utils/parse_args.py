...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=("whether or not sampling training frames double rate"),
    )
    parser.add_argument("--validation_data_dir", type=str, default=None, help="A prompt that is sampled during training for inference.")
    parser.add_argument(
